...
#define TLS_CLIENT_HTTP_REQUEST                                                \
    "GET /talkbacks/52920/commands/COMMAND_ID.json?api_key=371DAWENQKI6J8DD "  \
    "HTTP/1.1\r\n"                                                             \
...
extern bool run_tls_client_test(const uint8_t *cert,
                                size_t cert_len,
                                const char *server,
                                const char *request,
                                int timeout);
...
void tls_test(void)
{
    ...
    bool pass = run_tls_client_test(NULL,
                                    0,
                                    TLS_CLIENT_SERVER,
